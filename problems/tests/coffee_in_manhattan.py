...
def test_algo(matrix, people, algo, solution):
    m = deepcopy(matrix)
    print_matrix(m)
    ...
    m[x][y] = 'o'
    print_matrix(m)
    assert best_intersection == solution
...
if __name__ == "__main__":
    ...
    '''
    solution = (4, 2)
    test_algo(matrix, people, o_n_2, solution)
    test_algo(matrix, people, o_n_log_n, solution)
